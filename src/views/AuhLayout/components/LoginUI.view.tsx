...
import { ToastErrorForm } from "@/helpers";
...
export const LoginUIView: React.FC<ILoginUIHookProps> = ({ control, register, handleSubmit, errors, onSubmit, isLoading, backgroundImage }) => {
	...
	>
		...
		<div className="relative z-10 flex justify-center items-center w-full">
			...
			<div className="w-full max-w-[400px] sm:max-w-[60%] lg:max-w-[30%] 2xl:max-w-[25%] bg-white/50 backdrop-blur-sm rounded-xl shadow-2xl p-4 sm:p-6 md:p-8">
